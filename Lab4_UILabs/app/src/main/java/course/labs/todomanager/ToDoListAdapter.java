...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null){
			Toast.makeText(mContext,"in get view method nulls", Toast.LENGTH_LONG).show();
		}
	...
	//	titleView = (TextView)itemLayout.findViewById(R.id.titleView);
		...
		statusView.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
							boolean isChecked) {
						statusView.setChecked(true);
						Toast.makeText(mContext,"status check changed", Toast.LENGTH_LONG).show();
		...
		String dateFormat = ToDoItem.FORMAT.format(toDoItem.getDate());
